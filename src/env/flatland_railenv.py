...
# private
    ...
    def _encode_info(self, info, obs):
        ...
        for agent in self.agents:
            ...
            except: pass  # TODO crash for missing keys in deadlock conditions both here and _compute_rewards()
    ...
    def _compute_rewards(self, rewards, dones, info):
        ...
        for i_agent, agent in enumerate(self.agents):
            ...
            elif info["shortest_path_cost"][i_agent] < info["shortest_path_pre_cost"][i_agent]: #TODO len or cost?
