...
class TBLogger:
    ...
    def write(self, env, train_params, timers, step):
        ...
        self.writer.add_scalar("metrics/score", env.stats['normalized_score'], step)
        ...
        self.writer.add_scalar("actions/forward", env.stats['action_count'][RailEnvActions.MOVE_FORWARD], step)
        self.writer.add_scalar("actions/right", env.stats['action_count'][RailEnvActions.MOVE_RIGHT], step)
        self.writer.add_scalar("actions/stop", env.stats['action_count'][RailEnvActions.STOP_MOVING], step)
